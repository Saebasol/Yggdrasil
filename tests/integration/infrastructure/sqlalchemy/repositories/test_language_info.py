...
async def test_get_or_add_language_info_new_language_info(
    ...
    language_info = await language_info_repository.get_or_add_language_info(
        session, sample_language_info
    )

    assert language_info is not None
    assert isinstance(language_info, LanguageInfoSchema)
...
async def test_get_or_add_language_info_existing_language_info(
    ...
    first = await language_info_repository.get_or_add_language_info(
        session, sample_language_info
    )
    second = await language_info_repository.get_or_add_language_info(
        session, sample_language_info
    )
